...
class UserPage extends StatelessWidget {
  ...
  /// FORM CARD (INSERT)
  /// ================================
  Widget _buildFormCard(BuildContext context, UsersController controller) {
    return Card(
      color: Colors.white,
      elevation: 0,
          ...
          child: Column(
            ...
            children: [
              ...
              _buildTextField(
                ...
                validator: (v) => v!.isEmpty ? "Username can't be empty" : null,
              ),
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      if (controller.formKey.currentState!.validate()) {
                        final success = await controller.insertUser();
                        if (success) {
  ...
  /// EDIT CARD
  /// ================================
  Widget _buildEditCard(BuildContext context, UsersController controller) {
    return Card(
      color: Colors.white,
      elevation: 0,
      shape: RoundedRectangleBorder(
                        ...
                        if (success) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              backgroundColor: Colors.red,
                              content: Text(
                                "User admin@gmail.com tidak dapat diupdate!",
                              ),
                            ),
                          );
                        }
  ...
  /// DATA TABLE CARD
  /// ================================
  Widget _buildDataTableCard(BuildContext context, UsersController controller) {
    return Card(
      elevation: 0,
      color: Colors.white,
      shape: RoundedRectangleBorder(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: users.length == controller.rowsPerPage
                              ? () {
                                  controller.currentPage++;
                                  controller.notifyListeners();
                                }
